import{_ as B,u as P,r as w,g as A,h as E,o as S,c as K,a as p,t as b,i as x,n as V,p as q,f as G,W as T,S as U,P as D,j as N,k as X,V as l,M as Y,b as j}from"./moyrZwSY.js";import{v as $}from"./DWoqyjwh.js";const J=`precision mediump float;
...
`,Q=v=>(q("data-v-967d376c"),v=v(),G(),v),Z={class:"l-glsl_BgContents"},ee=Q(()=>p("div",null,"MOUSE POS",-1)),ne={__name:"BgGlsl_1",setup(v){const t=P();let d=null,h=null,s=null,c=null,y=null;const C=w(null),O=w(null),f=w({x:0,y:0});let a={x:0,y:0};const F=(e,r,i)=>({init:()=>{s=new T({alpha:!0,antialias:!1});const o=window.innerWidth,m=window.innerHeight;s.setPixelRatio(1),s.setSize(o,m),s.setClearColor(0,0),e.value.appendChild(s.domElement),d=new U;const g=60,L=g/2*(Math.PI/180),W=m/2/Math.tan(L);h=new D(g,o/m,1,W*2);const I=new N(2,2,10,10);c=new X({uniforms:{uAspect:{value:window.innerWidth/window.innerHeight},r:{value:new l(window.innerWidth,window.innerHeight)},uMouse:{value:a},t:{value:0},uRectMouseTopL:{value:new l(0,0)},uRectMouseTopR:{value:new l(0,0)},uRectMouseBottomL:{value:new l(0,0)},uRectMouseBottomR:{value:new l(0,0)}},vertexShader:$,fragmentShader:J,transparent:!0});const k=new Y(I,c);d.add(k);const R=()=>{if(y=requestAnimationFrame(R),s){s.render(d,h),c.uniforms.uMouse.value=a;const H=performance.now()/1e3;c.uniforms.t.value=H;let u=z();c.uniforms.uRectMouseTopL.value=new l(u.top_l.x,u.top_l.y),c.uniforms.uRectMouseTopR.value=new l(u.top_r.x,u.top_r.y),c.uniforms.uRectMouseBottomL.value=new l(u.bottom_l.x,u.bottom_l.y),c.uniforms.uRectMouseBottomR.value=new l(u.bottom_r.y,u.bottom_r.y)}};R()}}),z=()=>{const e=window.innerWidth,r=window.innerHeight;let i=_(t.mouseOverRect.top_l.x,t.mouseOverRect.top_l.y,e,r),n=_(t.mouseOverRect.top_r.x,t.mouseOverRect.top_r.y,e,r),o=_(t.mouseOverRect.bottom_l.x,t.mouseOverRect.bottom_l.y,e,r),m=_(t.mouseOverRect.bottom_r.x,t.mouseOverRect.bottom_r.y,e,r);return t.setMouseOverRectInt(i.x,i.y,n.x,n.y,o.x,o.y,m.x,m.y),{top_l:i,top_r:n,bottom_l:o,bottom_r:m}},_=(e,r,i,n)=>({x:(e*2-i)/Math.min(i,n),y:-(r*2-n)/Math.min(i,n)}),M=e=>{a.x=e.clientX,a.y=e.clientY;const r=e.clientX,i=e.clientY,n=window.innerWidth,o=window.innerHeight;a.x=(r*2-n)/Math.min(n,o),a.y=-(i*2-o)/Math.min(n,o),f.value&&(f.value.x=parseFloat(a.x.toFixed(4)),f.value.y=parseFloat(a.y.toFixed(4)))};return A(()=>{const{init:e}=F(C);e(),window.addEventListener("mousemove",M)}),E(()=>{s&&(cancelAnimationFrame(y),s.dispose(),s.forceContextLoss()),window.removeEventListener("mousemove",M)}),(e,r)=>(S(),K("div",Z,[p("div",{class:"glsl_BgContents",ref_key:"BgContents",ref:C},null,512),p("div",{class:V(["glsl_BgContents_debug",{isActive:x(t).isDebug}]),ref_key:"glsl_BgContents_debug",ref:O},[ee,p("div",null," x:"+b(x(f).x)+",y:"+b(x(f).y),1)],2)]))}},te=B(ne,[["__scopeId","data-v-967d376c"]]),oe={};function se(v,t){const d=te;return S(),K("div",null,[j(d)])}const le=B(oe,[["render",se]]);export{le as default};
