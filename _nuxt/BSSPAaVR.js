import{_ as S}from"./ByeSnw4G.js";import{q as y,r as _,B as h,v as U,o as D,c as E,a as M,W as R,P as p,S as W,T as A,K as B,A as F,M as k}from"./BJ_ANt-V.js";import{v as z}from"./C74dAFiS.js";const G=`  uniform sampler2D uTexture;
  varying vec2 vUv;
  uniform float uPos;
  uniform float uTime;
// 10色を定義
...
}`,K=y({__name:"mosaic2",setup(L){const f=_(null),d=_(null);var o,c=!1,a=new h,x={uPos:20,uTime:0,uTexture:o};const T=(s,C,q)=>({init:()=>{const n=new R({alpha:!0,antialias:!0});d.value.getBoundingClientRect();var v=0,t=0,i=new p(45,window.innerWidth/window.outerWidth,1,2e3);const l=new W,w=new A;var P=new B(16777215);l.add(P),o=w.load("/nuxt3/images/thumb/12.jpg",function(e){v=e.image.naturalWidth,t=e.image.naturalHeight,n.setSize(v,t),n.setPixelRatio(window.devicePixelRatio?window.devicePixelRatio:1);const r=60,m=r/2*(Math.PI/180),u=t/2/Math.tan(m);i=new p(r,v/t,1,u*2),i.position.z=u,s.value.appendChild(n.domElement),n.domElement.style.width="100%",b()}),n.debug.onShaderError=(e,r,m,u)=>{e.getShaderSource(m),e.getShaderSource(u),console.groupCollapsed("vertexShader"),console.groupEnd(),console.groupCollapsed("fragmentShader"),console.groupEnd()};function b(){const e=new F(v,t,1);console.log("texture",o),x.uTexture=o,a=new h({uniforms:{uTime:{value:0},uPos:{value:x.uPos},uTexture:{value:o}},vertexShader:z,fragmentShader:G});const r=new k(e,a);l.add(r),c=!0,console.log("isActive",c)}function g(e){requestAnimationFrame(g),c&&(a.uniforms.uPos.value=20,a.uniforms.uTime.value=e),n.render(l,i)}console.log(c),g(0),n.render(l,i)}});return U(()=>{const{init:s}=T(f);s()}),(s,C)=>(D(),E("div",{class:"webGL_glsi_box",ref_key:"container",ref:f},[M("img",{src:S,ref_key:"thumb",ref:d},null,512)],512))}});export{K as default};
